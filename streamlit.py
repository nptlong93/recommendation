...
if choice == 'Project Overview':    
    ...
    st.write("1. Processing raw data: Remove unnecessary phrases, Lowercase all words, Remove special characters, Replace emoji/teencode with text, punctuations with space, Replace multiple spaces with single space,.etc")
    st.write("2. Standardizing Vietnamese unicode")
    ...
    # insert html
    st.image("https://github.com/nptlong93/recommendation/blob/main/Content_based_EDA.png", width=650)
