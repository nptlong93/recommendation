...
# GUI
    ...
    for i in sorted_similar_products[1:6]:
        ...
        selected_image = image_select(label="Selected Image", images=[product_image[0],product_image[1]], captions=[product_name[0],product_name[1]], use_container_width = True)
