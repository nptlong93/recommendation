...
if choice == 'Project Overview':    
    ...
    st.write("1. Processing raw data")
    st.write("- Remove unnecessary phrases")
    st.write("- Lowercase all words")
    st.write("- Remove special characters")
    st.write("- Replace emoji/teencode with text")
    st.write("- Replace punctuations with space")
    st.write("- Replace multiple spaces with single space")
    st.write("- Replace misspelled words")
